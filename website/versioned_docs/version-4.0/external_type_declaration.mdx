...
Any annotations described in the [Authentication and authorization page](authentication_authorization.mdx) can be used in the `@SourceField` "annotations" attribute.
