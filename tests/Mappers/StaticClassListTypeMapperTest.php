...
class StaticClassListTypeMapperTest extends AbstractQueryProvider
{
    public function testClassListException(): void
    {
        ...
        $mapper = new StaticClassListTypeMapper(['NotExistsClass'], $typeGenerator, $inputTypeGenerator, $this->getInputTypeUtils(), $container, new \TheCodingMachine\GraphQLite\AnnotationReader(), new NamingStrategy(), $this->getTypeMapper(), $cache);
