 ...
 * @internal
 */
class MagicInputPropertyResolver implements SourceResolverInterface
{
    /** @var string */
    ...
    public function __invoke(...$args)
    {
        ...
        if (! method_exists($this->object, '__set')) {
            throw MissingMagicGetException::cannotFindMagicSet(get_class($this->object));
        }

        return $this->object->__set($this->propertyName);
    }
