...
class GlobControllerQueryProviderTest extends AbstractQueryProviderTest
{
    public function testGlob()
    {
        ...
        $globControllerQueryProvider = new GlobControllerQueryProvider('TheCodingMachine\\GraphQLite\\Fixtures', $this->getFieldsBuilderFactory(), $this->getTypeMapper(), $container, $this->getLockFactory(), new NullCache(), null, false);
