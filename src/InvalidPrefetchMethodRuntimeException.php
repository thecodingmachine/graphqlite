...
class InvalidPrefetchMethodRuntimeException extends GraphQLRuntimeException
{
     ...
     */
    public static function methodNotFound($reflector, ReflectionClass $reflectionClass, string $methodName, ReflectionException $previous)
    {
     ...
     * @param bool             $isSecond
     */
    public static function prefetchDataIgnored(ReflectionMethod $annotationMethod, bool $isSecond)
    {
